...
import 'package:eddonate/model/note.dart';
import 'package:eddonate/ui/note_screen.dart';
...
class _ListViewNoteState extends State<ListViewNote> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'smartminds Firebase DB Demo',
      home: Scaffold(
        appBar: AppBar(
          title: Text('smartminds Firebase DB Demo'),
          centerTitle: true,
